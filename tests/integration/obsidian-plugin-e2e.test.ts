...
// Types are erased at runtime anyway, and the plugin source is NOT part of this
// checkout — use loose assertion shapes so the e2e file compiles standalone.
import type { LooseDeep } from "../helpers/looseTypes.ts";
type VaultDiscoverResponse = LooseDeep;
type SyncManifestResponse = LooseDeep;
type SyncPullResponse = LooseDeep;
type SyncPushResponse = LooseDeep;
type TombstoneEntry = LooseDeep;
